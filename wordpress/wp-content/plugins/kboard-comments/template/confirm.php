...
<head>
	...
	* { font-family: Apple SD Gothic Neo,Malgun Gothic,arial,sans-serif,arial,sans-serif; }
	...
	.row-button button { padding: 10px; border: 0; background-color: transparent; color: #f28178; font-size: 20px; font-weight: bold; cursor: pointer; }
	</style>
</head>
<body>
...
<form id="kbaord-comments-confirm-form" method="post" action="<?php echo $submit_action_url?>" onsubmit="return password_checker(this)">
	<div class="kboard-popup-form">
		<div class="kboard-popup-row"><input type="password" name="password" placeholder="<?php echo __('Password', 'kboard-comments')?>" autofocus required></div>
